...
const MusicianList = ({musicians, sorting, setMusiciansSorting, connections}, props) => {
    ...
    const item = (musician) => {
        return (
            <div className="item" key={musician.name} onClick={()=>{navigate(`/musicians/${musician.name}`)}}>
                <div className="image">
...
const mapStateToProps = (state) => {
    return ({musicians: state.musiciansReducer.musicians, sorting: state.musiciansReducer.sorting, connections: state.connectionsReducer.connections, language: state.languagesReducer.language})
}
...
export default connect(mapStateToProps, mapDispatchToProps)(MusicianList);